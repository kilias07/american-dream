...
async function run() {
  ...
  await page('program', 'Program', [
    ...
    // Newsletter POD kalendarzem (uwaga klienta 2026-07, D6)
    { blockType: 'newsletterCTA', heading: 'NEWSLETTER', body: 'Zapisz się i bądź na bieżąco z programem koncertów.', placeholder: 'Adres email', buttonLabel: 'ZAPISZ SIĘ', consentText: 'Akceptuję politykę prywatności' },
    ...
    { blockType: 'newsletterCTA', heading: 'NEWSLETTER', body: 'Sign up and stay up to date with the concert programme.', placeholder: 'Email address', buttonLabel: 'SIGN UP', consentText: 'I accept the privacy policy' },
