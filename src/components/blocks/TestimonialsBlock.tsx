        ...
        {leaveReviewLabel && leaveReviewUrl && (
          <div className="flex justify-center mt-8">
            <a
              ...
              /* Bez ikony gwiazdki — uwaga klienta 2026-07 */
              className="inline-flex items-center bg-brand-gold text-brand-navy text-[12px] font-bold uppercase tracking-[0.12em] px-6 py-3 rounded-full hover:bg-brand-gold-dark transition-colors"
            >
              {leaveReviewLabel}
            </a>
          </div>
