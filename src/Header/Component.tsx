...
const SocialIcon = ({ platform }: { platform: string }) => {
  ...
  switch (platform) {
    ...
    case 'googleMaps':
      // Pinezka mapy — link do wizytówki Google (uwaga klienta 2026-07)
      return (
        <svg className={cls} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    case 'tripadvisor':
      return (
        <svg className={cls} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex items-center gap-4">
            {phone && (
              <a
                ...
                className="flex items-center gap-1.5 text-[15px] font-bold hover:opacity-70 transition-opacity"
              >
